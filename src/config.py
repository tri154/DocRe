...
def parse_args():
    ...
    parser.add_argument('--warmup_phase', type=int, default=2, help="number of warmup epoch.")
    # parser.add_argument('--rerouting_interval', type=int, default=1)
    parser.add_argument('--rerouting_epochs', type=int, nargs='+')
...
class Config:
    ...
    def another_logging(self, text, is_printed=False, print_time=False):
        if is_printed:
            print(text)
